...
=== USEing a DWARVEN SPHERE CROSSBOW, AIM gun at LEG.KNEE, THEN place ARM.HAND.FINGER on CROSSBOW.TRIGGER and SQUEEZE. THEN return CROSSBOW to HOLSTER. CHECK whether shoelace needs to be retied.
...
===or
===After correctly packaging your knee, you attempt to concurrently load the bow, pull the string, scream and shoot yourself in the knee. When you try, however, you discover that your foot is of the wrong type. 
===or
      procedure main is
...
=== All you remember is that you tried to shoot yourself with an arrow to the knee and held the bow with the wrong hand, the rest is a blank page.
